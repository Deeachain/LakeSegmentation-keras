...
def unet29_nobn(num_classes, input_shape, lr_init, lr_decay, vgg_weight_path=None):
    ...
    block_1_out = Conv2D(64, (3, 3), padding='same', name='block1_conv2')(x)
    # x = BatchNormalization()(x)
    ...
    block_2_out = Conv2D(128, (3, 3), padding='same', name='block2_conv2')(x)
    # x = BatchNormalization()(x)
    ...
    block_3_out = Conv2D(256, (3, 3), padding='same', name='block3_conv3')(x)
    # x = BatchNormalization()(x)
    ...
    block_4_out = Conv2D(512, (3, 3), padding='same', name='block4_conv3')(x)
    # x = BatchNormalization()(x)
...
if __name__ == "__main__":
    model = unet29_nobn(input_shape=(512, 512, 3), num_classes=2,
