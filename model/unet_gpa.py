...
def unet_gpa(num_classes, input_shape, lr_init, lr_decay, vgg_weight_path=None):
...
if __name__ == "__main__":
    model = unet_gpa(input_shape=(512, 512, 3), num_classes=2,
    ...
    # model.eval()
    model.summary()
    plot_model(model, to_file='unet_gpamodel.png', show_shapes=True)