...
import cv2
#
# dir_path = '/media/ding/学习/研一下学期/Lake Segmentation'
# origin_folder_path = '/media/ding/学习/研一下学期/Lake Segmentation/dataset/origin'
# label_folder_path = '/media/ding/学习/研一下学期/Lake Segmentation/dataset/label'
...
def make_h5py():
    ...
    # print('x_train_paths :',x_train_paths)
    # print('y_train_paths :',y_train_paths)
    x_val_paths, y_val_paths = get_data('val')
    #1823
    #/media/ding/Study/tianchi/nongye_ai/data/label/val/1_img_0_42496_.png
    print('y_val_path1823 :',y_val_paths[1823])
    print(y_val_paths[1824])
    # print('x_val_paths :', x_val_paths)
    # print('y_val_paths :', y_val_paths)
    x_test_paths, y_test_paths = get_data('test')
    # print('x_test_paths :', x_test_paths)
    # print('y_test_paths :', y_test_paths)


    # Make h5py file with write option.
    h5py_file = h5py.File(os.path.join(dir_path, 'nongye.h5'), 'w')
