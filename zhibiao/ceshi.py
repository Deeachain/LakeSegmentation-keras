...
# biaozhu_path = '/media/ding/学习/研一下学期/Lake Segmentation/评价/标注'
# predict_path = '/media/ding/学习/研一下学期/Lake Segmentation/评价/预测'
biaozhu_path = '/media/ding/学习/研一下学期/湖泊分割论文项目/评价hu/标注'
predict_path = '/media/ding/学习/研一下学期/湖泊分割论文项目/评价hu/预测'
...
for i in range(number_photo):
    i = i+1
    a = cv.imread(biaozhu_path + '/' + str(i) + '.png')
    b = cv.imread(predict_path + '/' + str(i) + '.png')
    print(biaozhu_path + '/' + str(i) + '.png',predict_path + '/' + str(i) + '.png')
    '''
...
print("pa:{}, mpa:{}, mIoU:{}, fwIoU: {}".format(sum(pa)/number_photo,
                                                 sum(mpa)/number_photo,
                                                 sum(miou) / number_photo,
                                                 sum(fwiou) / number_photo))
